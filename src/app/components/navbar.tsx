...
const Navbar = () => {
  ...
  return (
    <nav className="bg-blue-500 to-green-500 text-white px-4 md:px-8 py-4 flex items-center justify-between font-sans" data-aos="fade-down" data-aos-duration="3000">
      <div className="flex items-center space-x-4">
        ...
        <div className="font-bold text-xl tracking-wide">Sultan Store</div>
      </div>
      <ul
        className={`${
          isMenuOpen
